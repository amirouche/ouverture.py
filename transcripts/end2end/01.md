...
### Function 1: Rotate Quadrant (English)
`rotate_eng.py`
```python
...
### Function 1: Rotate Quadrant (Korean)
`rotate_kor.py`
```python
...
### Function 2: Distance to XY (English)
`d2xy_eng.py`
```python
...
### Function 2: Distance to XY (Korean)
`d2xy_kor.py`
```python
...
### Function 3: XY to Distance (English)
`xy2d_eng.py`
```python
from bb.pool import object_<ROTATE_HASH> as rotate_quadrant
...
### Function 3: XY to Distance (Korean)
`xy2d_kor.py`
```python
from bb.pool import object_<ROTATE_HASH> as 사분면_회전
