...
''')
    ...
    objects_dir = cli_runner.pool_dir / 'objects' / 'sha256'
...
''')
    ...
    func_dir = cli_runner.pool_dir / 'objects' / 'sha256' / func_hash[:2] / func_hash[2:]
...
''')
    ...
    func_dir = cli_runner.pool_dir / 'objects' / 'sha256' / eng_hash[:2] / eng_hash[2:]
