...
'''
    ...
    assert "_ouverture_v_0" in reverse_mapping
...
'''
    ...
    _, normalized_eng_no_doc, _, _, _ = ouverture.ast_normalize(tree_eng, "eng")
    _, normalized_fra_no_doc, _, _, _ = ouverture.ast_normalize(tree_fra, "fra")
...
'''
    ...
    normalized_with_doc, normalized_without_doc, _, _, _ = ouverture.ast_normalize(tree, "eng")
